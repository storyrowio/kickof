...
func SignIn(params models.AuthRequest) (*string, error) {
...
func Register(params models.AuthRequest, url string) (*string, error) {
	...
	request.Password = lib.HashAndSalt(params.Password)
	...
	err = lib.SendEmailVerification("verification", request.Email, data)
